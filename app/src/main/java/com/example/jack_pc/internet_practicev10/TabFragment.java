...
public class TabFragment extends Fragment {
    ...
    private LinkedList<BaseFragment> getFragments() {
        ...
        fragments.add(DebugFragment.newInstance(
                this.getResources().getString(R.string.tab_debug), indicatorColor, dividerColor));
        fragments.add(WashingClothesFragment.newInstance(
                this.getResources().getString(R.string.tab_washingclothes), indicatorColor, dividerColor));
        fragments.add(AirConditionFragment.newInstance(
                this.getResources().getString(R.string.tab_AC_controller), indicatorColor, dividerColor));
        fragments.add(TemperatureFragment.newInstance(
                this.getResources().getString(R.string.tab_temperature), indicatorColor, dividerColor));
        return fragments;
    }
}